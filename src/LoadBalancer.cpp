...
/**
 * @file WebServer.cpp
 * @brief Implementation of the WebServer class used by the load balancer.
 */
...
/**
 * @brief Checks if the server is available for processing a new request.
 *
...
/**
 * @brief Handles one clock cycle of processing.
 *
 * Decrements the time remaining for the current request, and sets the server to available
 ...
 *
 * @return Time remaining for the request.
 */
